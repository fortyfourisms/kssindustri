...
export const api = {
    ...
    getSurveyProgress: () => surveyService.getMyProgress(),
    getSurveyProgressByRespondentId: (respondenId: string | number) => surveyService.getProgress(respondenId),
    getSurveyRisk: () => surveyService.getMyRisk(),
    getSurveyRiskByRespondentId: (respondenId: string | number) => surveyService.getRiskByRespondent(respondenId),
