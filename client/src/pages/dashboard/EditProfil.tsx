...
const MUTED_BUTTON_CLS = "dashboard-secondary-button inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-semibold transition-all";
const DANGER_BUTTON_CLS = "inline-flex items-center gap-2 rounded-xl border border-[var(--dashboard-danger-soft-border)] bg-[var(--dashboard-danger-soft-bg)] px-4 py-2 text-sm font-semibold text-[var(--dashboard-danger-soft-fg)] shadow-sm transition-all hover:brightness-95";
const PRIMARY_BUTTON_CLS = "dashboard-primary-button inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold text-white transition-all hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50";
const EDIT_BUTTON_CLS = "dashboard-warning-button inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold text-white transition-all hover:-translate-y-0.5";
